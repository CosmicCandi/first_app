...
class ApplicationMigration < ActiveRecord::Migration
  def change
    create_table "lorems", force: true do |t|
      t.text     "name"
      t.text     "paragraph"
